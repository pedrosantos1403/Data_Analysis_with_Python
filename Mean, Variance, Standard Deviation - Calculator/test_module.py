...
class UnitTests(unittest.TestCase):
    ...
    def test_calculate(self):
        ...
        for (key1, value1), (key2, value2) in zip(expected.items(), actual.items()):
            for v1, v2 in zip(value1, value2):
                self.assertAlmostEqual(first=v1, second=v2, msg="Expected different output when calling 'calculate()' with '[2,6,2,8,4,0,1,5,7]'")
    ...
    def test_calculate2(self):
        ...
        for (key1, value1), (key2, value2) in zip(expected.items(), actual.items()):
            for v1, v2 in zip(value1, value2):
                self.assertAlmostEqual(first=v1, second=v2, msg="Expected different output when calling 'calculate()' with '[9,1,5,3,3,3,2,9,0]'")

    def test_calculate_with_few_digits(self):
        with self.assertRaisesRegex(ValueError, r"List must contain nine numbers."):
    ...
    def test_invalid_input(self):
        ...
        with self.assertRaises(ValueError) as context:
            mean_var_std.calculate(input_list)

        expected_message = "List must contain nine numbers."
